...
var Card = Object(styled_components__WEBPACK_IMPORTED_MODULE_2__["default"])(antd__WEBPACK_IMPORTED_MODULE_0__["Card"]).withConfig({
  displayName: "Card",
  componentId: "sc-1bx5rm2-0"
})(["-webkit-box-shadow:11px 16px 32px -6px rgba(0,0,0,0.19);-moz-box-shadow:11px 16px 32px -6px rgba(0,0,0,0.19);box-shadow:11px 16px 32px -6px rgba(0,0,0,0.19);.ant-card-cover{max-width:500px;max-height:330px;width:500px;height:330px;}", ";", ";"], styled_system__WEBPACK_IMPORTED_MODULE_3__["width"], styled_system__WEBPACK_IMPORTED_MODULE_3__["space"]);
...
//# sourceMappingURL=_app.js.f53b29e2558b4cfc4ec8.hot-update.js.map