...
function () {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(MyInfluencerViewModel, [{
    ...
    value: function changeEmailModalVisible(visible, id) {
      ...
      this.influencerSelected = this.listDetail.influencers.find(function (item) {
        return item.id == id;
      });
    }
  }, {
  ...
  writable: true,
  initializer: null
}), _descriptor12 = Object(_babel_runtime_corejs2_helpers_esm_applyDecoratedDescriptor__WEBPACK_IMPORTED_MODULE_6__["default"])(_class.prototype, "influencerSelected", [mobx__WEBPACK_IMPORTED_MODULE_8__["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
